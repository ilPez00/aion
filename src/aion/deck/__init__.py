...
The CyclUno (Arduino Uno + joysticks/wheel/buttons/OLED) is aion's physical
...
from .protocol import (  # noqa: F401
    ...
    SRC_JOY1, SRC_JOY2, SRC_WHEEL, SRC_BTN, SRC_MODE,
    CODE_STEP_X, CODE_STEP_Y, CODE_RAW_X, CODE_RAW_Y, CODE_WHEEL_STEP,
    BTN_A, BTN_B, BTN_J2, BTN_WHEEL, BTN_MODE, BTN_X, BTN_Y,
    MODE_AION, MODE_APP,
