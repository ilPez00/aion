...
from .storeswarm import SwarmCommands
...
class Store(SwarmCommands):
    """Owns all aion state and intent handling. UI-agnostic.

    The swarm half lives in `storeswarm.SwarmCommands` — same `self`, same
    call sites, just not in the middle of this file. See that module for what
    it depends on here.
    """
